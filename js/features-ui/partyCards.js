...
function renderPartyCard(m) {
    ...
    hpCur.addEventListener("input", () => _updateParty(m.id, { hpCurrent: numberOrNull(hpCur.value) }, false));
    ...
    hpMax.addEventListener("input", () => _updateParty(m.id, { hpMax: numberOrNull(hpMax.value) }, false));
