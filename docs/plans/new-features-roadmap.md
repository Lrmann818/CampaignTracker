...
- [ ] Abilities & Features polish, manual/freeform cards, custom cards, feature-use tracking, partial regain behavior, broader rest/resource automation, and specialized resource-linked cards
