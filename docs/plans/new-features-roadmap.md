...
- [ ] Abilities & Features follow-ups: fuller menu keyboard accessibility pass, possible `damageEffect` / `effectText` cleanup, feature-use tracking, partial regain behavior, broader rest/resource automation, and specialized resource-linked cards
