...
- Its builder Vitals shape is display-only groundwork for speed and hit dice. Missing or malformed builder species/class/level inputs return nullable display values and warnings, not persisted fallback values.
